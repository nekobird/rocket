...
export class CanvasDraw {
  ...
  public applyStyle(style: CanvasDrawStyle): this {
    ...
    if (computedStyle.noFill === false) this.context.fill();

    if (computedStyle.noStroke === false) this.context.stroke();
  ...
  public getPixelColor(point: Point): Color {
    ...
    color.rgba = [data[0] / 255, data[1] / 255, data[2] / 255, data[3] / 255];
    return color;
  }
