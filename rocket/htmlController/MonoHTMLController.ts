...
export class MonoHTMLController {
  ...
  // INITIALIZE
  public initialize(): MonoHTMLController {
    this
      .initialize_elements()
  ...
  private initialize_elements(): MonoHTMLController {
  ...
  private initialize_groupObjects(): MonoHTMLController {
    // Initialize Groups
  ...
  private initialize_activeItems(): MonoHTMLController {
  ...
  private item_activate(action: Action): MonoHTMLController {
  ...
  private item_deactivate(action: Action): MonoHTMLController {
  ...
  private handleAction_activation(actionName: 'activate' | 'deactivate', action: Action, callback?: Function): MonoHTMLController {
  ...
  private handleAction_toggle(action: Action, callback?: Function): MonoHTMLController {
  ...
  private endAction(callback?: Function): MonoHTMLController {
    if (this.isNestedAction === false) {
  ...
  private hub_action(action: Action, callback?: Function): MonoHTMLController {
  ...
  private hub_event(event: Event, actionName: ActionName): MonoHTMLController {
  ...
  private startListening(): MonoHTMLController {
  ...
  public stopListening(): MonoHTMLController {
    Array.from(this.els_js_activate).forEach(element => {
