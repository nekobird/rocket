...
const alignment = DOMAlign.getTargetAlignmentOffset(tooltip, 'bottom-left', box, 'top-right', 'viewport', 20);
const alignment2 = DOMAlign.getTargetAlignmentOffset(tooltipInner, 'bottom-right', box, 'top-left', box, 20);
const alignment3 = DOMAlign.getTargetAlignmentOffset(tooltipDoc, 'top-right', box, 'bottom-left', 'document', 20);
