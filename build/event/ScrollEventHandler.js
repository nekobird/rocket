...
export class ScrollEventHandler {
    ...
    update() {
        ...
        let currentVelocity = Vector2.subtract(this._position, currentPosition);
        this._acceleration.equals(Vector2.subtract(currentVelocity, this._velocity));
    ...
    handleScroll(event) {
        ...
        this._velocity.equals(Vector2.subtract(this._position, this._previousPosition));
        this._acceleration.equals(Vector2.subtract(this._velocity, this._previousVelocity));
